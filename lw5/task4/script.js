var time1 = ['08:30', '21:00'];
var time2 = ['05:20', '09:59'];
function isTimeRangesIntersect(timeRange1, timeRange2) {
  ...
  if((0 < (beginRange1 <= 2400) && 0 < (beginRange2 <= 2400) && 0 < (endRange1 <= 2400) && 0 < (endRange2 <= 2400)) && 
  (beginRange1.search(regTime) === 0 && beginRange2.search(regTime) === 0 && endRange1.search(regTime) === 0 && endRange2.search(regTime) === 0) ){
...
isTimeRangesIntersect(time1, time2);